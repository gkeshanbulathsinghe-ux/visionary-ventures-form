import visionary from "@/assets/visionary-ventures.asset.json";
import nuaiy from "@/assets/nuaiy-logo.asset.json";
import keltix from "@/assets/keltix-logo.asset.json";
